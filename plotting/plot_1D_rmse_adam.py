# plotting/plot_rmse_adam.py
"""
Plot RMSE vs sqrt(CRLB) for 1D Adam (gradient-based) MLE.
Requires: run_1D_adam.py to be run first.
"""
import sys, pathlib
...
def plot_rmse_vs_crlb(results_path, save_dir="figures/plot_rmse_adam"):
    ...
    plt.savefig(save_path / "rmse_vs_crlb_adam.pdf", dpi=300, bbox_inches="tight")
    plt.close()
